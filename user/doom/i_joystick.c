...
void I_InitJoystick(void)
{
    ...
    {
        libc_printf("I_InitJoystick: Invalid joystick ID: %d\n", joystick_index);
        SDL_QuitSubSystem(SDL_INIT_JOYSTICK);
        return;
    }
    ...
    if (joystick == NULL)
    {
        libc_printf("I_InitJoystick: Failed to open joystick #%d\n",
               joystick_index);
        SDL_QuitSubSystem(SDL_INIT_JOYSTICK);
        return;
    }
    ...
    {
        libc_printf("I_InitJoystick: Invalid joystick axis for joystick #%d "
